...
:local mtmHttpContainerPort "8080"
...
/container/envs/add list="trafficdb" key="HTTP_PORT" value=$mtmHttpContainerPort
/container/envs/add list="trafficdb" key="HTTP_LAN_PORT" value=$mtmHttpLanPort
...
:if ([:len [/ip/firewall/nat/find where comment="trafficdb-gui"]] = 0) do={
  /ip/firewall/nat/add chain=dstnat action=dst-nat protocol=tcp src-address=$mtmLanCidr dst-address=192.168.88.1 dst-port=$mtmHttpLanPort to-addresses=$mtmContainerIp to-ports=$mtmHttpContainerPort comment="trafficdb-gui"
} else={
  /ip/firewall/nat/set [find where comment="trafficdb-gui"] chain=dstnat action=dst-nat protocol=tcp src-address=$mtmLanCidr dst-address=192.168.88.1 dst-port=$mtmHttpLanPort to-addresses=$mtmContainerIp to-ports=$mtmHttpContainerPort
}
